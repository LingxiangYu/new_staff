#Final Project--Break-out--Coca vs Pepsi strategy
...
url = 'https://chart.finance.yahoo.com/table.csv?s=PEP&a=0&b=1&c=2014&d=3&e=17&f=2017&g=d&ignore=.csv'
response = urllib2.urlopen(url)
html = response.read()
with open('pep.csv', 'wb') as f:
    f.write(html)
"""
